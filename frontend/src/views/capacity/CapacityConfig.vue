...
const emptyLine: CapacityLine = { factoryCode: 'YH', lineCode: '', lineName: '', weeklyCapacity: 0, isActive: true, remark: '' }
  ...
  <div>
    ...
    <el-card shadow="never" v-loading="loading">
      <el-table :data="lines" size="small" border>
        ...
        <el-table-column label="操作" width="80" align="center">
          <template #default="{ row }"><el-button link type="primary" size="small" @click="startEdit(row)">编辑</el-button></template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog v-model="editDialogVisible" :title="isAdding ? '新增产线' : '编辑产线'" width="500px">
      <el-form v-if="editingLine" label-width="80px">
        <el-form-item label="工厂"><el-select v-model="editingLine.factoryCode"><el-option label="永惠" value="YH" /><el-option label="APK" value="APK" /></el-select></el-form-item>
